    ...
    <div className="flex h-full main">
        ...
        <div className="z-3 absolute">
          ...
          {explanation
            ...
            : <div className="text-white px-3 py-2 w-fit hover:scale-105 hover:translate-x-1 duration-150 hover:font-semibold cursor-pointer" onClick={toggleReadMore}>Read More</div>
            }
        </div>
