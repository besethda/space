    ...
    <div className="flex grow main">
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <div className="flex relative ">
          <div className="bg-radial from-[#923b22] to-black/80 w-fit px-[10vw] py-[20vh] md:px-[20vw] md:py-[10vh]  rounded-full shadow-[8px_12px_40px_20px] shadow-black">
          ...
          {data && <div className="absolute md:p-10 md:py-0 py-15 flex flex-col justify-between items-center h-full w-full txt font-semibold">
