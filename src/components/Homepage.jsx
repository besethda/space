...
const Homepage = () => {
  return (
    <div className="grid md:grid-cols-2 md:grid-rows-6 w-full gap-3 h-[70%] lg:h-[90%] py-[13%] mt-10 md:mt-5 lg:px-[23%] px-[20%] md:px-[10%] absolute text-white">
      ...
      <Link to="/mars" state={{ title: "Mars" }} className="gridItem hover:scale-[101%] box row-span-6 group">
        <video className="gridMedia" src={`${getMediaURL("mars.mp4")}`} loop autoPlay muted></video>
