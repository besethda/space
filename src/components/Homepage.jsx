...
const Homepage = () => {
  return(
    <div className="grid grid-cols-2 grid-rows-6 w-full gap-3 h-[90%] py-[13%] mt-5 px-88 absolute text-white">
      ...
      <Link to="/mars" state={{title: "Mars"}} className="gridItem box row-span-6 group relative overflow-hidden">
      ...
      <Link to="/asteroids" state={{title: "Asteroids"}} className="gridItem box relative row-span-4 overflow-hidden group">
